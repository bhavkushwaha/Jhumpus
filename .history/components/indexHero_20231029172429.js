         ...
         <div class="carousel-item active">
           <img src="Images/slider-1.jpg" alt="Logistics and Supply Chain Management" title="Logistics and Supply Chain Management">
             <div class="text-box">
                 ...
                 <span>Jhumpus</span> 
                 Consultancy Firm</h2>
                 <p class="wow fadeInLeft animated" data-wow-duration="2s" style="visibility: visible;-webkit-animation-duration: 2s; -moz-animation-duration: 2s; animation-duration: 2s;">
