function gpdmWhy() {
    const gpdmWhy = document.getElementById("gpdmWhy");
  ...
  >
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis luctus orci sem, eget fermentum mauris varius ac. Donec non pharetra est. Curabitur pretium metus finibus nulla vulputate, quis vestibulum ex dapibus.</p>
    <p>Nulla sed imperdiet nisi. Fusce auctor vel turpis quis luctus. Maecenas dictum eros non felis dignissim, at rhoncus lectus faucibus.</p>
  </div>

                <div class="lnk-gfq"><a href="contact-us.php">Contact Us</a></div>
    `;
    gpdmWhy.appendChild(Container);
  }
  gpdmWhy();