	...
	<!--<div aria-hidden="true">-->
		<div>
			...
			<!--		<p><b>Select options from the sentence below to define your trade needs.</b><br>Livingston can help Simplify Trade — starting with a fast-tracked quote.</p>-->
					...
					<div id="sentence-container" class="sentence align-center"> <span id="sentence-section0" data-index="0" data-selector="service" tabindex="-1">I want customs brokerage</span>  <span id="sentence-section1" data-index="1" data-selector="shipment-quantity" tabindex="-1" style="opacity: 1;">for <a tabindex="0">a one-time</a> shipment of</span>  <span id="sentence-section2" data-index="2" data-selector="product" tabindex="-1" style="opacity: 1;"><a tabindex="0">goods</a> moving</span>  <span id="sentence-section3" data-index="3" data-selector="origin" tabindex="-1" style="opacity: 1;">from <a tabindex="0">New York, NY</a></span>  <span id="sentence-section4" data-index="4" data-selector="destination" tabindex="-1" style="opacity: 1;">to <a tabindex="0">Toronto, ON.</a></span></div>
