function Navbar() {
  ...
  <ul class="navbar-nav d-none d-lg-flex">
    ...
    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
      <li><a class="dropdown-item" href="#">Global Product Data Management</a></li>
      <li><a class="dropdown-item" href="#">Global Trade Compliance</a></li>
      <li><a class="dropdown-item" href="#">Logistic Management</a></li>
      <li><a class="dropdown-item" href="#">Import Operations</a></li>
      <li><a class="dropdown-item" href="#">Export Operations</a></li>
    </ul>
  </li>
    <li class="nav-item">
