...
<div class="pages-hero-gpdm">
        ...
        <div class="small-6 medium-6 cell no-border">
        ...
        <h3 class="h4">
        Broker and Vendor Performance Management
        </h3>
        <p class="">
        Your goal: reduce the number of exceptions at time of import. We help you with strategic broker selection, from planning and 
        execution to establishing, monitoring, and updating the performance metrics of your service providers. 
        The focus is on cost-saving, quality, and cycle-time.
        </p>
        </div>
        <div class="small-12 medium-6 cell no-border">
        <h3 class="h4">Regulatory Agency Compliance</h3>
        <p class="">Every product has the potential to require its own set of documentation. We help you develop 
        and maintain product “passport” information for smooth clearance and compliance with regulatory agencies, 
        if applicable.
        </p>
        </div>
        </div>
