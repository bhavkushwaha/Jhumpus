  ...
  <div class="container">
   <div class="row">
    <div class="col-md-5 col-sm-12">
     <div class="abt-hm-lftbx wow fadeInLeft clearfix animated" data-wow-duration="2s" style="visibility: visible;-webkit-animation-duration: 2s; -moz-animation-duration: 2s; animation-duration: 2s;"><img src="Images/img3.png" alt="Logistics &amp; Trade Compliance" title="Logistics &amp; Trade Compliance"></div>
    </div>
